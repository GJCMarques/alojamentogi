        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="relative">
                <div class="aspect-[4/5] rounded-lg overflow-hidden shadow-2xl">
                    <div class="w-full h-full bg-gradient-to-br from-accent/20 to-cream flex items-center justify-center">
                        <svg class="w-24 h-24 text-accent opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                        </svg>
                    </div>
                </div>
                <!-- Decorative Badge -->
                <div class="absolute -bottom-6 -right-6 bg-secondary text-white p-6 rounded-lg shadow-xl">
                    <p class="text-3xl font-serif font-bold">1980</p>
                    <p class="text-sm text-accent/80">Ano de construção</p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="prose prose-lg text-charcoal space-y-4">
                    <p>
                        <strong>Construída nos anos 80</strong>, altura em que os "artistas da construção" e os "materiais" eram escassos por Terras de Mogadouro, este edifício foi mandado construir desde terras de Santa Cruz, por carta, e com os recursos de quem saiu da terra em busca de uma melhor oportunidade!
                    </p>
                    <p>
                    ...
                    <p>
                        Hoje, abrimos as portas desta casa especial para que possam experimentar o mesmo calor e acolhimento que sempre caracterizou este lugar. Aqui, cada canto conta uma história, cada janela emoldura uma paisagem única de Mogadouro.
                    </p>
                </div>
            </div>
        </div>
