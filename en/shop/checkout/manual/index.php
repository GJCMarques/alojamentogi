    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-sm border border-cream-100 p-10 lg:p-16 text-center animate-on-scroll" data-animation="fade-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center animate-on-scroll" data-animation="fade-up" data-delay="200">
                <a href="<?= $base ?>/en/" class="inline-flex items-center justify-center px-8 py-4 bg-primary text-cream font-semibold rounded-xl hover:bg-primary/90 transition-all duration-200 shadow-md hover:shadow-lg">
                    <?= $isEnglish ? 'Back to Home' : 'Voltar ao Inicio' ?>
                </a>
                <a href="<?= $base ?>/en/shop/" class="inline-flex items-center justify-center px-8 py-4 bg-white text-primary font-semibold rounded-xl border-2 border-cream-200 hover:bg-cream-50 transition-all duration-200">
