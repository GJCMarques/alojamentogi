    ...
    if ($action === 'update_profile') {
        ...
        if (!empty($newPassword)) {
            ...
            if (!preg_match('/[A-Z]/', $newPassword)) {
                $validator->addError('new_password', 'A password deve conter pelo menos uma letra maiúscula.');
            }
            if (!preg_match('/[0-9]/', $newPassword)) {
                $validator->addError('new_password', 'A password deve conter pelo menos um número.');
            }
...
<div class="bg-white rounded-lg shadow-sm p-6 border border-granite-200 mb-8">
    <div class="flex items-center gap-6">
        ...
        <div class="text-right text-sm space-y-1">
            ...
            <p class="text-granite-400 text-xs">Último login: <?= timeAgo($admin->last_login) ?></p>
            <?php endif; ?>
...
<div class="mt-8 bg-white rounded-lg shadow-sm p-6 border border-granite-200">
    ...
    <div class="grid md:grid-cols-3 gap-6">
        <div>
            <p class="text-xs text-granite-500 uppercase tracking-wider font-medium mb-1">Sessão Atual</p>
        ...
        <div>
            <p class="text-xs text-granite-500 uppercase tracking-wider font-medium mb-1">Ações</p>
