...
<section class="relative h-screen flex items-center bg-primary overflow-hidden">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        <p class="text-xl md:text-2xl text-cream/90 max-w-2xl mx-auto font-light leading-relaxed animate-on-scroll" data-animation="fade-up" data-delay="200">
            Transmontana hospitality, family moments and memories forever.
        </p>
    </div>
</section>
...
<section class="pt-24 pb-0 bg-white relative overflow-hidden" id="choose-casa">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 animate-on-scroll" data-animation="fade-up">
            <span class="text-accent text-sm font-bold tracking-[0.2em] uppercase mb-4 block">Two Houses, One Experience</span>
            <h2 class="font-serif text-3xl md:text-5xl text-primary mb-6">Choose Your Refuge</h2>
            <p class="text-charcoal/70 text-lg max-w-2xl mx-auto">
                Both houses offer the same comfort and Transmontana hospitality. Choose the one that best suits your needs.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <a href="?casa=<?= $casa['accommodation_number'] ?>" class="group flex flex-col bg-primary rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 overflow-hidden animate-on-scroll" data-delay="<?= ($idx + 1) * 100 ?>">
                ...
                <div class="relative p-8 md:p-10 flex-1 flex flex-col bg-primary text-white">
                    <!-- Tag -->
                    <span class="text-accent text-xs font-bold tracking-widest uppercase mb-4 block">Accommodation</span>
        ...
        <div class="mt-20 mb-16 text-center animate-on-scroll" data-animation="fade-up" data-delay="300">
            <h3 class="font-serif text-2xl text-primary mb-8">What Both Houses Offer</h3>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="flex flex-col items-center gap-3 p-4">
                    ...
                    <span class="text-sm font-medium text-charcoal">Free Wi-Fi</span>
                </div>
                <div class="flex flex-col items-center gap-3 p-4">
                    <div class="w-14 h-14 rounded-full bg-cream-100 flex items-center justify-center text-secondary">
                    ...
                    <span class="text-sm font-medium text-charcoal">Self Check-in</span>
                </div>
                <div class="flex flex-col items-center gap-3 p-4">
                    <div class="w-14 h-14 rounded-full bg-cream-100 flex items-center justify-center text-secondary">
                ...
                <div class="flex flex-col items-center gap-3 p-4">
                    ...
                    <span class="text-sm font-medium text-charcoal">Central Location</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="relative h-screen flex items-center bg-primary overflow-hidden">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-5 py-2.5 rounded-full mb-8 animate-on-scroll" data-animation="fade-up" data-delay="50">
            ...
            <span class="text-white/90 text-sm font-medium tracking-wide uppercase"><?= $accommodation['reviews_count'] ?> Reviews</span>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="mt-8 animate-on-scroll" data-animation="fade-up" data-delay="500">
            <a href="<?= $base ?>/en/accommodation/" class="inline-flex items-center gap-2 text-white/60 hover:text-white transition-colors group">
                <svg class="w-4 h-4 group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                <span class="text-sm font-medium">View All Houses</span>
            </a>
        </div>
    </div>
</section>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0 lg:divide-x lg:divide-secondary/10">
                ...
                <div class="flex items-center justify-center gap-4 lg:px-4 group cursor-default">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-xs font-semibold text-charcoal/50 uppercase tracking-widest mt-1">Guests</span>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center gap-4 lg:px-4 group cursor-default">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-xs font-semibold text-charcoal/50 uppercase tracking-widest mt-1">Bedrooms</span>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center gap-4 lg:px-4 group cursor-default">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-xs font-semibold text-charcoal/50 uppercase tracking-widest mt-1">Bathroom</span>
                    </div>
                </div>
        ...
        <div class="grid lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div class="lg:col-span-8 space-y-16">
                ...
                <div class="animate-on-scroll" data-animation="fade-up">
                    <span class="text-accent font-bold tracking-[0.2em] uppercase text-xs block mb-4">The Experience</span>
                    <h2 class="font-serif text-3xl md:text-5xl text-primary mb-8 !leading-[1.2]" style="line-height: 1.2 !important;">
                        A refuge of <span class="italic text-accent">charm</span> and tranquility.
                    </h2>
                    <div class="prose prose-lg prose-charcoal max-w-none font-light leading-relaxed text-charcoal/80">
                        <?= $accTranslation['description'] ?? '<p>Casa do Gi is synonymous with simplicity, hospitality and memorable moments.</p>' ?>
                    </div>
                </div>
                ...
                <!-- 2. Highlights (Icons) -->
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-6 py-8 border-y border-cream-200 animate-on-scroll" data-animation="fade-up" data-delay="100">
                    <div class="flex items-center gap-4 group">
                        ...
                        <span class="font-medium text-primary text-sm tracking-wide">Self check-in</span>
                    </div>
                    <div class="flex items-center gap-4 group">
                        <div class="w-12 h-12 rounded-full bg-cream-50 border border-cream-200 flex items-center justify-center text-secondary group-hover:scale-110 group-hover:bg-secondary group-hover:text-white transition-all duration-300">
                             <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                        </div>
                        <span class="font-medium text-primary text-sm tracking-wide">max. <?= $accommodation['max_guests'] ?? 6 ?> guests</span>
                    </div>
                     <div class="flex items-center gap-4 group">
                        <div class="w-12 h-12 rounded-full bg-cream-50 border border-cream-200 flex items-center justify-center text-secondary group-hover:scale-110 group-hover:bg-secondary group-hover:text-white transition-all duration-300">
                        ...
                        <span class="font-medium text-primary text-sm tracking-wide">Towels and sheets</span>
                    </div>
                </div>
                ...
                <div class="animate-on-scroll" data-animation="fade-up">
                    <h3 class="font-serif text-2xl text-primary mb-8">The Spaces</h3>
                            ...
                            <div class="space-y-6">
                                ...
                                <ul class="space-y-5">
                                    ...
                                    <li class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <span class="block font-semibold text-primary"><?= e($bedroom['room_name'] ?? 'Bedroom ' . $bedroom['bedroom_number']) ?></span>
                                            <span class="text-charcoal/70 text-sm font-light"><?= e($bedroom['beds_description'] ?? 'Bed') ?></span>
                                        </div>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                            ...
                            <div class="space-y-6">
                                ...
                                <ul class="space-y-5">
                                    ...
                                    <li class="flex items-start gap-3">
                                        <div class="w-1.5 h-1.5 rounded-full bg-secondary mt-2 flex-shrink-0"></div>
                                        <div>
                                            <span class="block font-semibold text-primary"><?= e($bathroom['bathroom_name'] ?? 'Bathroom ' . $bathroom['bathroom_number']) ?></span>
                                            <span class="text-charcoal/70 text-sm font-light"><?= e($bathroom['description'] ?? 'Toilet, shower') ?></span>
                                        </div>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                ...
                <div class="animate-on-scroll" data-animation="fade-up">
                    <div class="flex items-end justify-between mb-8 border-b border-cream-200 pb-4">
                         <h3 class="font-serif text-2xl text-primary">Amenities</h3>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] p-8 border border-cream-200 sticky top-32 animate-on-scroll" data-animation="fade-left">
                    <div class="text-center mb-8">
                        <span class="text-accent text-xs font-bold tracking-widest uppercase mb-2 block">Availability</span>
                        <h3 class="font-serif text-3xl text-primary">Book Now</h3>
                        <p class="text-charcoal/60 text-sm mt-2">Book your stay through GuestReady</p>
                    </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-100 text-center">
                        <p class="text-charcoal/60 text-sm mb-4">Have any questions or special requests?</p>
                        <a href="<?= $base ?>/en/contact/" class="inline-flex items-center justify-center w-full px-6 py-3 border-2 border-primary text-primary font-medium rounded-xl hover:bg-primary hover:text-white transition-all duration-300 group">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 bg-cream-50/50 -mx-8 -mb-8 p-8 rounded-b-3xl">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <div class="text-center">
                                <span class="block text-xs uppercase text-charcoal/50 font-bold tracking-wide mb-1">Check-in</span>
                            ...
                            <div class="text-center">
                                <span class="block text-xs uppercase text-charcoal/50 font-bold tracking-wide mb-1">Check-out</span>
                                <span class="font-serif text-xl text-primary"><?= substr($accommodation['check_out_time'] ?? '11:00', 0, 5) ?></span>
                            </div>
                        </div>
                         <div class="text-center">
                            <span class="text-[10px] uppercase text-charcoal/40 tracking-widest">License <?= $accommodation['license_number'] ?? '146729/AL' ?></span>
                         </div>
                    </div>
                </div>
...
<section class="py-16 pt-24 bg-cream-50 overflow-hidden" id="gallery-section">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-14 animate-on-scroll">
            <span class="text-accent text-sm font-medium tracking-[0.2em] uppercase mb-3 block">Interiors</span>
            <h2 class="font-serif text-3xl md:text-4xl text-primary mb-4">
                Image Gallery
            </h2>
            <p class="text-charcoal/70 max-w-2xl leading-relaxed">
                A look inside Casa do Gi <?= $selectedAccommodationNumber ?>, where every detail tells a story.
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="space-y-8 animate-on-scroll" data-animation="fade-right">
                <div>
                    <span class="text-accent text-sm font-medium tracking-[0.2em] uppercase mb-3 block">The Destination</span>
                    <h2 class="font-serif text-3xl md:text-4xl text-primary mb-4">
                        <?= e($accTranslation['activity_section_title'] ?? 'Mogadouro & Surroundings') ?>
                    </h2>
                    <div class="prose prose-charcoal text-charcoal/80 leading-relaxed mb-8">
                        <?= $accTranslation['activity_section_description'] ?? 'Mogadouro is a historic town in the heart of the Planalto Mirandês, where tradition blends with nature. From Casa do Gi, you can explore the Castle of Mogadouro, walk trails in the Douro International Natural Park and savor unique local cuisine.' ?>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                    <a href="<?= $base ?>/en/activities/" class="inline-flex items-center justify-center gap-2 bg-secondary text-white px-8 py-4 rounded-full hover:bg-secondary-700 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                        <span class="font-medium tracking-wide">Discover Activities</span>
                    ...
                    <button onclick="document.getElementById('map-section-title').scrollIntoView({behavior: 'smooth'})" class="inline-flex items-center justify-center gap-2 border border-secondary text-secondary px-8 py-4 rounded-full hover:bg-secondary hover:text-white transition-all">
                        <span class="font-medium tracking-wide">View on Map</span>
            ...
            <div class="bg-cream-50 rounded-3xl p-8 md:p-10 border border-cream-100 animate-on-scroll" data-animation="fade-left">
                <h3 class="font-serif text-2xl text-primary mb-6">Stay Policies</h3>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <h4 class="font-bold text-primary">Cancellation and Refund</h4>
                        </div>
                        <p class="text-charcoal/70 text-sm leading-relaxed pl-11">
                            <?= e($accTranslation['cancellation_policy'] ?? 'Free cancellation up to 30 days before check-in. Cancellations after this period are subject to fees according to the reservation platform.') ?>
                        </p>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <h4 class="font-bold text-primary">Other Information</h4>
                        </div>
                        <p class="text-charcoal/70 text-sm leading-relaxed pl-11">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <h4 class="font-bold text-primary">House Rules</h4>
                        </div>
                        <ul class="space-y-2 pl-11 text-sm text-charcoal/70">
                            ...
                            <?php else: ?>
                                ...
                                <li>• Quiet hours: 10:00 PM - 08:00 AM.</li>
                ...
                <div class="mt-8 pt-6 border-t border-cream-200">
                    <p class="text-[11px] text-charcoal/50 italic leading-relaxed">
                        Note: The information presented here is for informational purposes only and is not exhaustive. All policies, full rules, and the booking process are fully managed by the GuestReady platform. Please consult the <a href="<?= $base ?>/en/terms-and-conditions/" class="underline hover:text-primary transition-colors">Terms and Conditions</a>.
                    </p>
                </div>
            </div>
...
<section class="relative pt-20 pb-16 bg-cream-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16 animate-on-scroll" id="map-section-title">
            <span class="text-accent text-sm font-medium tracking-[0.2em] uppercase mb-3 inline-block">Location</span>
...
<div id="lightbox-modal" class="fixed inset-0 z-[100] bg-black/95 hidden opacity-0 transition-opacity duration-300 flex flex-col">
    ...
    <div class="bg-gradient-to-t from-black/70 to-transparent py-4 md:py-6">
        <div class="max-w-4xl mx-auto px-4">
            <div id="thumbnail-carousel" class="flex items-center justify-start gap-2 md:gap-3 overflow-x-auto py-4 scrollbar-hide">
...
<div id="amenities-modal" class="fixed inset-0 z-[100] bg-black/50 hidden opacity-0 transition-opacity duration-300 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden" onclick="event.stopPropagation()">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h3 class="font-serif text-xl text-primary">All Amenities</h3>
...
<div id="policies-modal" class="fixed inset-0 z-[100] bg-black/50 hidden opacity-0 transition-opacity duration-300 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden" onclick="event.stopPropagation()">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h3 class="font-serif text-xl text-primary">House Rules</h3>
