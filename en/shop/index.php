<?php
/**
 * A Casa do Gi - Shop Main Page (English)
 */
...
// Page configuration
$pageTitle = $currentCategory ? $currentCategory->name . ' - Shop' : 'Shop';
                ...
                <div id="filter-sidebar" class="hidden lg:block bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-cream-200 p-8 sticky top-32 transition-all duration-300">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="<?= $base ?>/en/shop/?categoria=<?= e($category->slug) ?>"
                    ...
                    <div class="mt-8 pt-6 border-t border-cream-100 text-center">
                        <a href="<?= $base ?>/en/shop/" class="group inline-flex items-center gap-2 text-xs uppercase tracking-widest text-charcoal/50 hover:text-secondary font-bold transition-colors">
            ...
            <div class="flex-1">
                ...
                <div class="mb-8 flex items-center justify-between animate-on-scroll" data-animation="fade-up">
                    <p class="text-charcoal/60 text-sm font-light">
                        <?php if ($search): ?>
                            Found <strong class="text-primary font-medium"><?= $totalProducts ?></strong> results for "<?= e($search) ?>"
                        <?php else: ?>
                            Showing <strong class="text-primary font-medium"><?= count($products) ?></strong> of <?= $totalProducts ?> products
                        <?php endif; ?>
                    </p>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm p-16 text-center border border-cream-100 animate-on-scroll" data-animation="fade-up">
                    ...
                    <p class="text-charcoal/60 mb-8 max-w-md mx-auto font-light">
                        <?php if ($search): ?>
                            We couldn't find what you're looking for. Try using different terms.
                        <?php else: ?>
                            This category doesn't have products available yet.
                        <?php endif; ?>
                    </p>
                    <a href="<?= $base ?>/en/shop/" class="inline-flex items-center px-8 py-3 bg-primary text-white font-medium rounded-full hover:bg-primary-700 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                        View all products
                    </a>
                </div>
