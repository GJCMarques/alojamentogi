 ...
 * Enhanced with rating, reviews, location, host type, check-in info, etc.
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['add_amenity']) && !isset($_POST['edit_amenity'])) {
    if (CSRF::validate($_POST['csrf_token'] ?? '')) {
        ...
        $db->update('accommodation', [
            ...
            'region' => sanitize($_POST['region'] ?? 'Tras-os-Montes'),
...
<div class="bg-white rounded-lg shadow-sm mb-6">
    <div class="border-b border-gray-200">
        <nav class="flex -mb-px" id="mainTabs">
            <button type="button" id="tab-btn-info" class="nav-tab-btn px-6 py-3 text-sm font-medium border-b-2 border-secondary-600 text-secondary-600">
                Informacoes
            </button>
            <button type="button" id="tab-btn-content" class="nav-tab-btn px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                Conteudos
            </button>
            <button type="button" id="tab-btn-gallery" class="nav-tab-btn px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                Galeria
            </button>
            <button type="button" id="tab-btn-amenities" class="nav-tab-btn px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                Comodidades
            </button>
            <button type="button" id="tab-btn-policies" class="nav-tab-btn px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                Politicas
            </button>
        </nav>
    </div>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-lg font-medium text-gray-800 mb-4">Detalhes Basicos</h2>
                ...
                <!-- Rating & Reviews -->
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-lg font-medium text-gray-800 mb-4">Avaliacao & Reviews</h2>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Classificacao (0-5)</label>
                            <input type="number" name="rating" value="<?= e($accommodation['rating'] ?? '') ?>" min="0" max="5" step="0.1"
                                   placeholder="Ex: 4.8"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Numero de Reviews</label>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="region" value="<?= e($accommodation['region'] ?? 'Tras-os-Montes') ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary-500">
                        </div>
                        <div>
                ...
                <!-- Building Info -->
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-lg font-medium text-gray-800 mb-4">Informacoes do Edificio</h2>
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Licenca AL</label>
                    ...
                    <div class="flex flex-wrap gap-6">
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="towels_linens_included" value="1" <?= ($accommodation['towels_linens_included'] ?? 1) ? 'checked' : '' ?>
                                   class="w-4 h-4 text-secondary-600 border-gray-300 rounded focus:ring-secondary-500">
                            <span class="ml-2 text-sm text-gray-700">Toalhas e roupa de cama incluidas</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <!-- Host Type -->
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-lg font-medium text-gray-800 mb-4">Tipo de Anfitriao</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="checkin_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary-500">
                                ...
                                <option value="meet_host" <?= ($accommodation['checkin_type'] ?? '') === 'meet_host' ? 'selected' : '' ?>>Encontro com Anfitriao</option>
                ...
                <!-- Booking Options -->
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-lg font-medium text-gray-800 mb-4">Opcoes de Reserva</h2>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Noites Minimas</label>
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="instant_booking" value="1" <?= ($accommodation['instant_booking'] ?? 0) ? 'checked' : '' ?>
                                   class="w-4 h-4 text-secondary-600 border-gray-300 rounded focus:ring-secondary-500">
                            <span class="ml-2 text-sm text-gray-700">Reserva instantanea</span>
                        </label>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm">
            ...
            <div class="lang-content p-6 <?= $i > 0 ? 'hidden' : '' ?>" data-lang="<?= $lang['code'] ?>">
                <div class="space-y-6">
                    ...
                    <!-- Description -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Descricao Geral</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Descricao do Check-in</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Descricao da Localizacao</label>
                        <textarea name="location_description_<?= $lang['id'] ?>" rows="3"
                                  placeholder="Descreva o bairro, acessos, pontos de interesse proximos..."
                    ...
                    <!-- Host Description -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Sobre o Anfitriao</label>
                        <textarea name="host_description_<?= $lang['id'] ?>" rows="3"
                                  placeholder="Apresentacao do anfitriao..."
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                ...
                <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="p-3 space-y-3 bg-gray-50">
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">Titulo (PT)</label>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 mb-1">Titulo (EN)</label>
    ...
    <div id="panel-policies" class="admin-tab-panel hidden">
        <div class="bg-white rounded-lg shadow-sm">
            ...
            <div class="policy-lang-content p-6 <?= $i > 0 ? 'hidden' : '' ?>" data-lang="<?= $lang['code'] ?>">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Politica de Cancelamento / Reembolso</label>
                    <textarea name="refund_policy_<?= $lang['id'] ?>" rows="6"
                              placeholder="Descreva a politica de cancelamento e reembolso..."
        ...
        <form id="amenityForm" action="" method="post" class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="amenity_name_pt" id="amenityNamePt" placeholder="Ex: Wi-Fi Gratis" required
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary-500">
                </div>
                <div>
...
(function() {
    ...
    // Main Tab Switching
    // ID-based Tab Switching
    function switchTabById(tabName) {
        // Tabs and Panels IDs
        const tabs = ['info', 'content', 'gallery', 'amenities', 'policies'];
