...
if (isPost() && $formEnabled) {
    ...
    if (!CSRF::isValid()) {
        $errors['csrf'] = 'O formulário expirou por motivos de segurança. Por favor, recarregue a página.';
    } else {
        ...
        <div class="grid lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-1 animate-on-scroll" data-animation="fade-right">
                ...
                <div class="mt-10 p-6 bg-primary rounded-lg animate-on-scroll" data-animation="fade-up" data-delay="300">
                    ...
                    <p class="text-cream/80 text-sm mb-4">
                        Reserve a sua estadia através da GuestReady.
                    </p>
            ...
            <div class="lg:col-span-2 animate-on-scroll" data-animation="fade-left" data-delay="200" id="formulario" style="scroll-margin-top: 120px;">
                <div class="bg-white rounded-lg shadow-sm p-8 border border-charcoal/20">
                    ...
                    <form method="POST" action="#formulario" class="space-y-6" onsubmit="const b=this.querySelector('button[type=submit]');b.disabled=true;b.innerHTML='<svg class=\'animate-spin w-5 h-5 mr-2 inline-block\' fill=\'none\' viewBox=\'0 0 24 24\'><circle class=\'opacity-25\' cx=\'12\' cy=\'12\' r=\'10\' stroke=\'currentColor\' stroke-width=\'4\'></circle><path class=\'opacity-75\' fill=\'currentColor\' d=\'M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\'></path></svg>A enviar...';">
                        <?= CSRF::tokenField() ?>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="submit" class="inline-flex items-center px-5 sm:px-8 py-2.5 sm:py-3 bg-secondary text-white text-sm sm:text-base font-medium rounded hover:bg-secondary-700 focus:ring-2 focus:ring-secondary focus:ring-offset-2 transition-colors">
                                <svg class="w-6 h-6 mr-1.5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
