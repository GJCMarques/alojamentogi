<?php
/**
 * A Casa do Gi - Order Confirmation Page (English)
 */
...
<nav class="bg-cream-200 py-3 border-b border-cream-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ol class="flex items-center text-sm text-charcoal/60">
            ...
            <li><a href="<?= $base ?>/en/shop/" class="hover:text-secondary"><?= $isEnglish ? 'Shop' : 'Loja' ?></a></li>
            <li><span class="mx-2">/</span></li>
...
<section class="py-12 lg:py-16 bg-cream-50 min-h-[60vh]">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?= $base ?>/en/" class="inline-flex items-center justify-center px-8 py-3 bg-primary text-white font-medium rounded-full hover:bg-primary-700 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                <?= $isEnglish ? 'Back to Home' : 'Voltar ao Inicio' ?>
            </a>
            <a href="<?= $base ?>/en/shop/" class="inline-flex items-center justify-center px-8 py-3 bg-white text-primary font-medium rounded-full border border-cream-200 hover:bg-cream-50 transition-all">
