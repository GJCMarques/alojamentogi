...
<section class="py-12 lg:py-16 bg-cream-50 min-h-[60vh]">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl shadow-sm p-10 text-center border border-cream-100">
            ...
            <a href="<?= $base ?>/en/shop/checkout/" class="inline-flex items-center px-6 py-3 bg-secondary text-white rounded-full hover:bg-secondary-700 transition-all">
        ...
        <div class="grid lg:grid-cols-5 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-3xl shadow-sm border border-cream-100 p-6 sticky top-32">
                    ...
                    <div class="mt-6">
                        <a href="<?= $base ?>/en/" class="block text-center text-sm text-secondary hover:text-secondary-700 transition-colors">
    ...
    const pollInterval = setInterval(function() {
        ...
        .then(data => {
            if (data.status === 'paid') {
                ...
                setTimeout(() => {
                    window.location.href = base + '/en/shop/checkout/confirmation/?order=' + orderId;
                }, 1500);
