...
$blockDefinitions = [
    'homepage' => [
        ...
        'blocks' => [
            'home_hero_title' => ['label' => 'Hero - Titulo', 'type' => 'text'],
            'home_hero_subtitle' => ['label' => 'Hero - Subtitulo', 'type' => 'text'],
            'home_intro_title' => ['label' => 'Introducao - Titulo', 'type' => 'text'],
            'home_intro_text' => ['label' => 'Introducao - Texto', 'type' => 'textarea'],
            'home_accommodation_title' => ['label' => 'Alojamento - Titulo', 'type' => 'text'],
            'home_accommodation_text' => ['label' => 'Alojamento - Texto', 'type' => 'textarea'],
            'home_shop_title' => ['label' => 'Loja - Titulo', 'type' => 'text'],
            'home_shop_text' => ['label' => 'Loja - Texto', 'type' => 'textarea'],
        ]
    ],
    'about' => [
        'label' => 'Sobre Nos',
        'blocks' => [
            'about_title' => ['label' => 'Titulo', 'type' => 'text'],
            'about_intro' => ['label' => 'Introducao', 'type' => 'textarea'],
            'about_story_title' => ['label' => 'Historia - Titulo', 'type' => 'text'],
            'about_story_text' => ['label' => 'Historia - Texto', 'type' => 'wysiwyg'],
            'about_mission_title' => ['label' => 'Missao - Titulo', 'type' => 'text'],
            'about_mission_text' => ['label' => 'Missao - Texto', 'type' => 'textarea'],
        ]
    ],
    'accommodation' => [
        'label' => 'Alojamento',
