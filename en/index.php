    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-6 z-10">
        <div id="hero-content">
            ...
            <p class="hero-animate-up hero-delay-3 text-cream/80 text-lg md:text-xl font-light max-w-2xl mx-auto">
                <?= $content['home_hero_subtitle'] ?? 'Where Transmontana tradition meets modern comfort' ?>
            </p>
        </div>
    </div>
</section>
...
<div class="relative h-screen w-full flex flex-col md:flex-row overflow-hidden" id="split-hero">
    <div class="split-hero-left split-panel split-left relative w-full md:w-1/2 h-1/2 md:h-full group overflow-hidden">
        ...
        <div class="split-content-left split-content absolute inset-0 flex flex-col items-center justify-center text-center p-8 z-10">
            ...
            <h2 class="font-cursive text-5xl md:text-7xl lg:text-8xl text-cream mb-8 drop-shadow-2xl transition-transform duration-500 group-hover:-translate-y-2 group-hover:text-white">
                <?= $content['home_split_left_title'] ?? 'Refuge' ?>
            </h2>
            <div class="opacity-0 translate-y-8 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0 delay-200">
                <a href="<?= $base ?>/en/accommodation/" class="inline-flex items-center justify-center px-10 py-4 backdrop-blur-md bg-white/10 border border-white/30 text-white font-medium tracking-widest uppercase text-xs rounded-full transition-all duration-300 hover:bg-white hover:text-primary shadow-xl hover:shadow-2xl hover:scale-105">
                    View Accommodation
                </a>
            </div>
        </div>
    ...
    <div class="split-hero-right split-panel split-right relative w-full md:w-1/2 h-1/2 md:h-full group overflow-hidden">
        ...
        <div class="split-content-right split-content absolute inset-0 flex flex-col items-center justify-center text-center p-8 z-10">
            ...
            <h2 class="font-cursive text-5xl md:text-7xl lg:text-8xl text-cream mb-8 drop-shadow-2xl transition-transform duration-500 group-hover:-translate-y-2 group-hover:text-white">
                <?= $content['home_split_right_title'] ?? 'Tradition' ?>
            </h2>
        ...
        <div class="flex flex-col md:flex-row h-[800px] gap-2 md:gap-4">
                ...
                <div class="absolute bottom-0 left-0 w-full p-8 md:p-12 z-10 flex flex-col justify-end h-full">
                    ...
                    <div class="max-h-0 overflow-hidden group-hover:max-h-40 transition-all duration-700 ease-out opacity-0 group-hover:opacity-100">
                        <p class="text-white/90 text-lg font-light mt-4 max-w-md leading-relaxed">
                            <?= $content['home_card1_text'] ?? 'Experience the comfort of our rustic houses.' ?>
                        </p>
                        <span class="inline-flex items-center mt-6 text-white text-sm font-bold uppercase tracking-widest border-b border-accent pb-1"><?= $content['home_card1_cta'] ?? 'View Rooms' ?></span>
                    </div>
                </div>
            </a>
            ...
            <a href="<?= $base ?>/en/activities/" class="animate-on-scroll delay-100 relative flex-1 group duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] overflow-hidden rounded-3xl cursor-pointer">
                ...
                <div class="absolute bottom-0 left-0 w-full p-8 md:p-12 z-10 flex flex-col justify-end h-full">
                    ...
                    <div class="max-h-0 overflow-hidden group-hover:max-h-40 transition-all duration-700 ease-out opacity-0 group-hover:opacity-100">
                        <p class="text-white/90 text-lg font-light mt-4 max-w-md leading-relaxed">
                            <?= $content['home_card2_text'] ?? 'Discover the nature and history of Mogadouro.' ?>
                        </p>
                        <span class="inline-flex items-center mt-6 text-white text-sm font-bold uppercase tracking-widest border-b border-accent pb-1"><?= $content['home_card2_cta'] ?? 'Explore' ?></span>
                    </div>
                </div>
            </a>
            ...
            <a href="<?= $base ?>/en/shop/" class="animate-on-scroll delay-200 relative flex-1 group duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] overflow-hidden rounded-3xl cursor-pointer">
                ...
                <div class="absolute bottom-0 left-0 w-full p-8 md:p-12 z-10 flex flex-col justify-end h-full">
                    ...
                    <div class="max-h-0 overflow-hidden group-hover:max-h-40 transition-all duration-700 ease-out opacity-0 group-hover:opacity-100">
                        ...
                        <span class="inline-flex items-center mt-6 text-white text-sm font-bold uppercase tracking-widest border-b border-accent pb-1"><?= $content['home_card3_cta'] ?? 'Shop Now' ?></span>
                    </div>
                </div>
            </a>
            ...
            <a href="<?= $base ?>/en/contact/" class="animate-on-scroll delay-300 relative flex-1 group duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] overflow-hidden rounded-3xl cursor-pointer">
                ...
                <div class="absolute bottom-0 left-0 w-full p-8 md:p-12 z-10 flex flex-col justify-end h-full">
                    ...
                    <div class="max-h-0 overflow-hidden group-hover:max-h-40 transition-all duration-700 ease-out opacity-0 group-hover:opacity-100">
                        <p class="text-white/90 text-lg font-light mt-4 max-w-md leading-relaxed">
                            <?= $content['home_card4_text'] ?? 'Get in touch with us and plan your visit.' ?>
                        </p>
                        <span class="inline-flex items-center mt-6 text-white text-sm font-bold uppercase tracking-widest border-b border-accent pb-1"><?= $content['home_card4_cta'] ?? 'Get in Touch' ?></span>
                    </div>
                </div>
            </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div class="md:order-1 animate-on-scroll">
                <span class="text-accent text-xs font-bold tracking-[0.3em] uppercase block mb-6">
                    <?= $content['home_about_label'] ?? 'Our Story' ?>
                </span>
                <h2 class="font-serif text-4xl md:text-5xl lg:text-6xl text-primary mb-8 leading-tight">
                    <?= $content['home_about_title'] ?? 'More than a house,<br>a <span class="italic text-accent">legacy</span>.' ?>
                </h2>
                ...
                <div class="mt-12">
                     <a href="<?= $base ?>/en/about-us/" class="inline-flex items-center gap-3 px-8 py-4 bg-primary text-white rounded-full transition-all duration-300 hover:bg-accent hover:scale-105 shadow-lg group">
                        <span class="text-xs font-bold tracking-[0.2em] uppercase"><?= $content['home_about_cta'] ?? 'Read Full Story' ?></span>
