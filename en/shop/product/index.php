<?php
/**
 * A Casa do Gi - Single Product Page (English)
 */
...
if (!$product) {
    ...
    <section class="py-20 bg-cream-100">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="font-serif text-3xl text-granite-800 mb-4">Product not found</h1>
            <p class="text-granite-600 mb-8">The product you're looking for doesn't exist or has been removed.</p>
    ...
    <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <nav class="mb-4 animate-on-scroll" data-animation="fade-up" aria-label="Breadcrumb">
            <ol class="flex items-center text-sm text-white/90 flex-wrap">
                <li>
                    <a href="<?= $base ?>/en/" class="hover:text-white transition-colors">Home</a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?= $base ?>/en/shop/" class="hover:text-white transition-colors">Shop</a>
                </li>
                ...
                <li>
                    <a href="<?= $base ?>/en/shop/?categoria=<?= e($product->category->slug) ?>" class="hover:text-white transition-colors">
        ...
        <!-- Category Tag -->
        <?php if ($product->category): ?>
        <a href="<?= $base ?>/en/shop/?categoria=<?= e($product->category->slug) ?>"
...
<section class="py-12 lg:py-16 bg-cream-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="animate-on-scroll" data-animation="fade-up" data-delay="100">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center text-sm">
                        ...
                        <span class="font-medium text-secondary">In stock</span>
                        <?php if ($product->track_inventory && $product->stock_quantity <= 5): ?>
                        <span class="text-terracotta ml-3 font-medium">(Only <?= $product->stock_quantity ?> available)</span>
                        <?php endif; ?>
                    </div>
                    <?php else: ?>
                    <div class="flex items-center text-sm">
                        ...
                        <span class="font-medium text-charcoal/60">Out of stock</span>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <form id="add-to-cart-form" class="mb-8">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        <label for="quantity" class="text-charcoal font-semibold text-sm">Quantity:</label>
                ...
                <div class="bg-cream-100 rounded-xl p-6 mb-8 border border-cream-200">
                    <p class="text-charcoal/80 mb-4">
                        This product is temporarily out of stock. Please contact us to know when it will be available.
                    </p>
                    <a href="<?= $base ?>/en/contact/" class="inline-flex items-center text-secondary font-semibold hover:text-primary transition-colors">
                        Contact us
                ...
                <div class="bg-white rounded-xl p-6 border border-cream-200">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div class="flex items-start text-sm text-charcoal">
                            ...
                            <div>
                                <div class="font-semibold text-primary">Secure payment</div>
                                <div class="text-xs text-charcoal/60 mt-0.5">Protected transactions</div>
                            </div>
                        </div>
                        <div class="flex items-start text-sm text-charcoal">
                            <div class="flex-shrink-0 w-10 h-10 bg-secondary/10 rounded-lg flex items-center justify-center mr-3">
                            ...
                            <div>
                                <div class="font-semibold text-primary">Shipping to Portugal</div>
                                <div class="text-xs text-charcoal/60 mt-0.5">Fast and secure delivery</div>
                            </div>
                        </div>
                        <div class="flex items-start text-sm text-charcoal">
                            <div class="flex-shrink-0 w-10 h-10 bg-secondary/10 rounded-lg flex items-center justify-center mr-3">
                            ...
                            <div>
                                <div class="font-semibold text-primary">Careful packaging</div>
                                <div class="text-xs text-charcoal/60 mt-0.5">Well protected products</div>
                            </div>
                        </div>
                        <div class="flex items-start text-sm text-charcoal">
                            <div class="flex-shrink-0 w-10 h-10 bg-secondary/10 rounded-lg flex items-center justify-center mr-3">
                            ...
                            <div>
                                <div class="font-semibold text-primary">Customer support</div>
                                <div class="text-xs text-charcoal/60 mt-0.5">We're here to help</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-16 bg-white rounded-2xl p-8 lg:p-12 shadow-sm border border-cream-200 animate-on-scroll" data-animation="fade-up">
            <h2 class="font-serif text-3xl text-primary mb-6 pb-4 border-b border-cream-200">Product Description</h2>
...
<section class="py-16 lg:py-20 bg-cream-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 animate-on-scroll" data-animation="fade-up">
            ...
            <h2 class="font-serif text-3xl md:text-4xl text-primary">Related Products</h2>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <article class="product-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-cream-200 animate-on-scroll" data-animation="fade-up" data-delay="<?= $ridx * 100 ?>">
                <a href="<?= $base ?>/en/shop/product/?slug=<?= e($related->slug) ?>" class="block aspect-square relative overflow-hidden">
                ...
                <div class="p-5">
                    <a href="<?= $base ?>/en/shop/product/?slug=<?= e($related->slug) ?>" class="block">
        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Success feedback
                    submitBtn.innerHTML = '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Added!';
